...
class GitHubClient:
    ...
    def request_json(self, path: str, query: dict[str, Any] | None = None) -> Any:
        ...
        headers = {
            ...
            "User-Agent": "catnap-metadata-gate/1.0",
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate catnap metadata gates from trusted sources.")
    ...
    parser.add_argument("--merge-group-head-sha", default=os.environ.get("MERGE_GROUP_HEAD_SHA", os.environ.get("GITHUB_SHA", "")))
