...
| fswrs | 上架通知改为“有库存再发” | 部分完成（3/4） | `fswrs-listed-stock-gate/SPEC.md` | 2026-03-11 | review-fix 已同步：监控用户首次有库存 fallback 不再依赖 listed 开关，并补齐 mixed-reason / Web Push 场景；待 PR/checks/review-loop 收口 |
