...
| vye92 | CI/CD：Release Snapshot 队列化发布与 PR 版本评论 | 部分完成（5/6） | `vye92-release-snapshot-pr-comment/SPEC.md` | 2026-03-17 | 实现已落地：split workflows / snapshot / queue / PR comment；待 fast-track PR 合并并补发 `v0.9.0`、`v0.10.0` |
