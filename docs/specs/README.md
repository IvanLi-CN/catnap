...
| uqe6j | 系统设置：通知测试按钮（Telegram + Web Push） | 已完成 | `uqe6j-settings-notifications-test-button/SPEC.md` | 2026-03-03 | Telegram：错误信息增强（description + migrate_to_chat_id/retry_after）；Web Push：补齐发送链路（VAPID private/subject）用于测试  |
