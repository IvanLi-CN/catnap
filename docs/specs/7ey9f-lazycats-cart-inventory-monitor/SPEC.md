...
- 目标：对 `https://lxc.lazycat.wiki/cart` 的产品“配置（plan/config）”做库存监控与通知，避免手动频繁刷新页面。
...
- 不做多上游/多站点通用化（仅围绕 `lxc.lazycat.wiki/cart`）。
...
- `docs/specs/7ey9f-lazycats-cart-inventory-monitor/contracts/http-apis.md`: 随接口冻结与变更更新。
- `docs/specs/7ey9f-lazycats-cart-inventory-monitor/contracts/config.md`: 运行时配置项与默认值。
- `docs/specs/7ey9f-lazycats-cart-inventory-monitor/ui/README.md`: UI 信息架构与线框图（wireframes）。
...
- 上游抓取策略（事实观察）：
- `lxc.lazycat.wiki/cart` 页面包含“国家地区”“可用区域”“配置卡片”三层结构。
...
- `docs/specs/7ey9f-lazycats-cart-inventory-monitor/ui/README.md`
- `docs/specs/7ey9f-lazycats-cart-inventory-monitor/ui/inventory-monitor.svg`
- `docs/specs/7ey9f-lazycats-cart-inventory-monitor/ui/products.svg`
- `docs/specs/7ey9f-lazycats-cart-inventory-monitor/ui/settings.svg`
- `docs/specs/7ey9f-lazycats-cart-inventory-monitor/ui/logs.svg`
- `docs/specs/7ey9f-lazycats-cart-inventory-monitor/ui/unauthorized-401.svg`
- 临时预览（PNG，便于快速查看，可删）：
  - `docs/specs/7ey9f-lazycats-cart-inventory-monitor/tmp/ui-previews/README.md`
  - `docs/specs/7ey9f-lazycats-cart-inventory-monitor/tmp/ui-previews/*.png`
