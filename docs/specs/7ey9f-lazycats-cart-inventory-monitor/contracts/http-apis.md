...
- Response（响应）:
  - `200`:
    - `{"user":{"id":"u_123"},"catalog":{"countries":[],"regions":[],"configs":[],"fetchedAt":"2026-01-18T00:00:00Z","source":{"url":"https://lxc.lazycat.wiki/cart"}},"monitoring":{"enabledConfigIds":[],"poll":{"intervalSeconds":60,"jitterPct":0.1}},"settings":{"notifications":{"telegram":{"enabled":false},"webPush":{"enabled":false}},"siteBaseUrl":null}}`
