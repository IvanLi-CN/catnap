...
- 对仅存在 topology、暂时没有套餐的地区/可用区，products 页仍需保留可筛选/可监控的空态入口。
...
- 2026-03-11: 根据 review 补齐迁移边界、禁止 country-scope 套餐生命周期通知，并让 topology-only 空态 scope 在 products 中可筛选访问。
